...
const WordDetectiveBoard: React.FC<WordDetectiveBoardProps> = ({ puzzles, settings, onReturnToMenu, onGameEnd }) => {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-sm shadow-2xl rounded-3xl p-6 md:p-8 border-2 border-dark-brown/20 w-full max-w-3xl mx-auto animate-fade-in relative">
