...
const ResultsScreen: React.FC<ResultsScreenProps> = ({ score, totalQuestions, onRestart, onBackToMenu, xpGained, levelledUp, oldProgress, newProgress }) => {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-sm shadow-2xl rounded-3xl p-8 md:p-12 text-center border-2 border-dark-brown/20 animate-fade-in">
      ...
      <div className="bg-dark-brown/5 rounded-2xl p-6 mb-8 animate-bounce-in" style={{animationDelay: '200ms'}}>
        <p className="text-xl">Your Score</p>
        <p className="text-6xl font-bold text-teal my-2">{score} <span className="text-3xl font-medium text-dark-brown/60">/ {totalQuestions}</span></p>
      ...
      <div className="mb-8">
          ...
          <div className="w-full">
            <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-sm font-semibold text-dark-brown/70">{displayProgress.xp} / {xpForDisplayLevel} XP</span>
            </div>
            <div className="w-full bg-dark-brown/10 rounded-full h-4 overflow-hidden">
                <div 
